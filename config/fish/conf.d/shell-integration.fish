...
# See also on-event, on-variable, on-job-exit, on-process-exit, and on-signal
# Custom events can be emitted using the `emit` builtin,
# see https://fishshell.com/docs/current/language.html#event for builtin events.
